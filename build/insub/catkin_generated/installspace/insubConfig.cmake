...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'insub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/slavaglaps/two1/install/${idir}'.  Ask the maintainer 'slavaglaps <slavaglaps@todo.todo>' to fix it.")
    endif()
