...
(cl:defmethod cl:initialize-instance :after ((m <TwoInts>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TwoInts)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name insub-msg:<TwoInts> is deprecated: use insub-msg:TwoInts instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <TwoInts>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader insub-msg:a-val is deprecated.  Use insub-msg:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <TwoInts>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader insub-msg:b-val is deprecated.  Use insub-msg:b instead.")
  (b m))
